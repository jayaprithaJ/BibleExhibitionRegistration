...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!registrationOpen) {
      toast.error('Registration opens on May 28, 2026. Please check back after this date.');
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4 max-w-2xl">
        {/* Header with BIBLIO '26 branding */}
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-black text-cyan-600 mb-2" style={{ fontFamily: 'Impact, sans-serif' }}>
            BIBLIO '26
          </h1>
          <p className="text-gray-700 text-xl font-semibold">Group Registration</p>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-red-800 mb-2">
                  Online registration is currently closed and will open on <strong>May 28, 2026</strong>.
                </p>
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              {!registrationOpen ? 'Registration Opens May 28, 2026' : loading ? 'Registering...' : 'Register Now'}
            </button>
          </form>
        </div>
      </div>
